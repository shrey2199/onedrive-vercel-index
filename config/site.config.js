...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'index@shrey23.eu.org',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/shrey2199',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/s_rawal',
    },
  ],
